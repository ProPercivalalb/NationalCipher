...
public class StatCompiler {
	...
	public static void main(String[] args) {
		...
		String plainText = "".replaceAll(" ", "").toUpperCase();
		...
		EnigmaMachine machine = EnigmaLib.ZAHLWERK;
		
		String cipherText = Enigma.encode(plainText, machine, "ABC", "HOY", new int[] {0, 1, 2}, 0);
