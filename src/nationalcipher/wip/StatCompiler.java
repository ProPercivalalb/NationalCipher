...
public class StatCompiler {
	...
	public static void main(String[] args) {
		System.out.println(VigenereNicodemus.encode("MONEYCANTBUYHAPPINESSBUTITSUREMAKESMISERYEASIERTOLIVEWITH", "MONEY"));
		
		registerStatistics();
		for(IRandEncrypter en : new IRandEncrypter[] {new TriSquare()})
			for(Class<? extends TextStatistic> clz : map.values())
				StatisticHandler.calculateStatPrint(en, clz, 100);
		
		//TODO
		//for(IRandEncrypter en : new IRandEncrypter[] {new BeaufortNicodemus(), new PortaNicodemus(), new VariantNicodemus(), new VigenereNicodemus()})
		//	for(Class<? extends TextStatistic> clz : new Class[] {StatisticMaxNicodemus3to15.class}) 
