...
public class StatCompiler {
	...
	public static void main(String[] args) {
		...
		String plainText = "".replaceAll(" ", "").toUpperCase();
		...
		String cipherText = Enigma.encode(plainText, machine, "ACB", "HTE", new int[] {0, 1, 2}, 0);
