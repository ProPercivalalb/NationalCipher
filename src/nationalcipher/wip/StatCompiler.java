...
public class StatCompiler {
	...
	public static void main(String[] args) {
		...
		char[] plainText = "".replaceAll(" ", "").toUpperCase().toCharArray();
		byte[] plainText2 = new byte[plainText.length];
		int[] ring = new int[] {0, 0, 0};
		int[] rotors = new int[] {0, 1, 2};
