...
public class BeaufortSlidefair implements IRandEncrypter {

	public static void main(String[] args) {
		//THESLIDEFAIRCANBEUSEDWITHVIGENEREVARIANTORBEAUFORT
		System.out.println(new String(encode("THESLIDEFAIRCANBEUSEDWITHVIGENEREVARIANTORBEAUFORT", "DIGRAPH")));
	...
	public static String encode(String plainText, String key) {
		...
		for(int i = 0; i < key.length(); i++)
			for(int k = 0; k < 26; k++) 
				keyAlpha[i] += (char)((26 + key.charAt(i) - 'A' - k) % 26 + 'A');
