...
public abstract class NicodemusAttack extends CipherAttack {
	...
	public class NicodemusTask extends KeySearch implements ShortCustomKey, PermutateString {
		...
		public void onIteration(String key) {
			this.lastSolution = new Solution(NicodemusAttack.this.decode(this.cipherText, this.plainText, key), this.getLanguage());
		...
		public Solution tryModifiedKey(String key) {
			return new Solution(NicodemusAttack.this.decode(this.cipherText, this.plainText, key), this.getLanguage()).setKeyString(key).bakeSolution();
		}
