...
public class QuagmireIandIIDecrypt implements IDecrypt {

	private QuagmireTask task;
	
	@Override
	public String getName() {
		return "Quagmire I and II";
	}
	...
	public class QuagmireTask extends SimulatedAnnealing  {
		...
		public Solution generateKey() {
			...
			return new Solution(this.decode(this.bestMaximaKey1), this.settings.getLanguage());
		}
		...
		public char[] decode(String key) {
	        ...
	        for(int i = 0; i < this.period; ++i) {
	            ...
	            int shift = this.findBestCaesarShift(temp.toCharArray(), keyIndex, this.settings.getLanguage());
