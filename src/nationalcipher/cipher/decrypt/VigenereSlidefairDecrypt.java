...
public class VigenereSlidefairDecrypt implements IDecrypt {
	...
	public class VigenereSlidefairTask extends KeySearch implements VigenereAutoKey {
		...
		public void onIteration(String key) {
			this.lastSolution = new Solution(VigenereSlidefair.decode(this.cipherText, key), this.settings.getLanguage()).setKeyString(key);
		...
		public Solution tryModifiedKey(String key) {
			return new Solution(VigenereSlidefair.decode(this.cipherText, key), this.settings.getLanguage()).setKeyString(key);
		}
