...
public class VariantSlidefairDecrypt implements IDecrypt {
	...
	public void attemptDecrypt(String text, Settings settings, DecryptionMethod method, Output output, KeyPanel keyPanel, ProgressValue progress) {
		VariantSlidefairTask task = new VariantSlidefairTask(text.toCharArray(), settings, keyPanel, output, progress);
	...
	public class VariantSlidefairTask extends KeySearch implements VigenereAutoKey {
		
		public VariantSlidefairTask(char[] text, Settings settings, KeyPanel keyPanel, Output output, ProgressValue progress) {
			super(text, settings, keyPanel, output, progress);
		}

		@Override
		public void onIteration(String key) {
			this.lastSolution = new Solution(VariantSlidefair.decode(this.cipherText, key), this.settings.getLanguage()).setKeyString(key);
		...
		public Solution tryModifiedKey(String key) {
			return new Solution(VariantSlidefair.decode(this.cipherText, key), this.settings.getLanguage()).setKeyString(key);
		}
