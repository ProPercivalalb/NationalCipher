...
public class VariantSlidefairDecrypt implements IDecrypt {
	...
	public class VariantSlidefairTask extends KeySearch implements VigenereAutoKey {
		...
		public void onIteration(String key) {
			this.lastSolution = new Solution(VariantSlidefair.decode(this.text, key), this.settings.getLanguage()).setKeyString(key);
		...
		public Solution tryModifiedKey(String key) {
			return new Solution(VariantSlidefair.decode(this.text, key), this.settings.getLanguage()).setKeyString(key);
		}
