...
public class VariantAutokeyDecrypt implements IDecrypt {
	...
	public class VariantAutokeyTask extends KeySearch implements VigenereAutoKey {
		...
		public void onIteration(String key) {
			this.lastSolution = new Solution(VariantAutokey.decode(this.text, key), this.settings.getLanguage()).setKeyString(key);
		...
		public Solution tryModifiedKey(String key) {
			return new Solution(VariantAutokey.decode(this.text, key), this.settings.getLanguage()).setKeyString(key);
		}
