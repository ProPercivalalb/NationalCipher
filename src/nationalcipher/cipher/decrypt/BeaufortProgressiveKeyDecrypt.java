...
public class BeaufortProgressiveKeyDecrypt implements IDecrypt {

	@Override
	public String getName() {
		return "Beaufort ProgressiveKey";
	}
	...
	public void attemptDecrypt(String text, Settings settings, DecryptionMethod method, Output output, KeyPanel keyPanel, ProgressValue progress) {
		BeaufortProgressiveKeyTask task = new BeaufortProgressiveKeyTask(text.toCharArray(), settings, keyPanel, output, progress);
	...
	public class BeaufortProgressiveKeyTask extends KeySearch implements VigenereAutoKey {
		
		public int progPeriod;
		public int progIndex;
		
		public BeaufortProgressiveKeyTask(char[] text, Settings settings, KeyPanel keyPanel, Output output, ProgressValue progress) {
		...
		public void onIteration(String key) {
			this.lastSolution = new Solution(BeaufortProgressiveKey.decode(this.cipherText, key, this.progPeriod, this.progIndex), this.settings.getLanguage()).setKeyString(key).setKeyString("%s, PP-%d, PI-%d", key, this.progPeriod, this.progIndex);;
		...
		public Solution tryModifiedKey(String key) {
			return new Solution(BeaufortProgressiveKey.decode(this.cipherText, key, this.progPeriod, this.progIndex), this.settings.getLanguage()).setKeyString("%s, PP-%d, PI-%d", key, this.progPeriod, this.progIndex);
		}
