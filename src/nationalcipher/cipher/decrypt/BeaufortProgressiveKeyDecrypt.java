...
public class BeaufortProgressiveKeyDecrypt implements IDecrypt {
	...
	public class BeaufortProgressiveKeyTask extends KeySearch implements VigenereAutoKey {
		...
		public void onIteration(String key) {
			this.lastSolution = new Solution(BeaufortProgressiveKey.decode(this.text, key, this.progPeriod, this.progIndex), this.settings.getLanguage()).setKeyString(key).setKeyString("%s, PP-%d, PI-%d", key, this.progPeriod, this.progIndex);;
		...
		public Solution tryModifiedKey(String key) {
			return new Solution(BeaufortProgressiveKey.decode(this.text, key, this.progPeriod, this.progIndex), this.settings.getLanguage()).setKeyString("%s, PP-%d, PI-%d", key, this.progPeriod, this.progIndex);
		}
