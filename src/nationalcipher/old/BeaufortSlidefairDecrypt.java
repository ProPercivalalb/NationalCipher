...
public class BeaufortSlidefairDecrypt implements IDecrypt {

	@Override
	public String getName() {
		return "Beaufort Slidefair";
	}
	...
	public void attemptDecrypt(String text, Settings settings, DecryptionMethod method, Output output, KeyPanel keyPanel, ProgressValue progress) {
		BeaufortSlidefairTask task = new BeaufortSlidefairTask(text.toCharArray(), settings, keyPanel, output, progress);
	...
	public class BeaufortSlidefairTask extends KeySearch implements VigenereAutoKey {
		
		public BeaufortSlidefairTask(char[] text, Settings settings, KeyPanel keyPanel, Output output, ProgressValue progress) {
			super(text, settings, keyPanel, output, progress);
		}

		@Override
		public void onIteration(String key) {
			this.lastSolution = new Solution(BeaufortSlidefair.decode(this.cipherText, key), this.settings.getLanguage()).setKeyString(key);
		...
		public Solution tryModifiedKey(String key) {
			return new Solution(BeaufortSlidefair.decode(this.cipherText, key), this.settings.getLanguage()).setKeyString(key);
		}
