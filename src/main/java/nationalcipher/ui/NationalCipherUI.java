...
public class NationalCipherUI extends JFrame implements IApplication {
    ...
    private void initComponents() {
        ...
        // this.toolBarStop.setIcon(ImageUtil.createImageIcon("/image/stop.png",
        // "Terminate"));
        ...
        // this.toolBar.add(ButtonUtil.createIconButton(ImageUtil.createImageIcon("/image/text_letterspacing.png",
        // "Remove Letters")));
        ...
        // this.menuItemIoC.setIcon(ImageUtil.createImageIcon("/image/chart_bar.png",
        // "Letter Frequency"));
        ...
        for (ILanguage language : Languages.languages) {
            ...
            group.add(jmi);
            if (language == this.settings.getLanguage())
        ...
        // saPreset3.addActionListener(new PresetAction(tempSetting, tempStepSetting,
        // countSetting, 20D, 0.1D, 100));
        ...
        public void updateOnWithTextArea() {
            ...
            if (!text.isEmpty() && text.length() % 2 == 0) {
                ...
                for (int period = 2; period <= 40; period++) {
                    ...
                    // double sqDiff = StatCalculator.calculateIC(string.toCharArray(), 2, false) *
                    // 1000;
                    double sumIC = 0.0D;
                    for (int i = 0; i < period; i++) {
                        double total = 0D;
    ...
    private class EncodeAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            if (Math.abs(esitmated - acutal) > esitmated * -0.30) {
                ...
                int n = JOptionPane.showOptionDialog(NationalCipherUI.this, "This text doesn't seem to be English\nDo you wish to continue?", "Random Encryption", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, icon, options, options[1]);
