 ...
 * 
 * public PeriodicGromarkAttack() { super("Periodic Gromark"); }
 * 
 * @Override public byte[] decode(char[] cipherText, byte[] plainText, String
 *           key) { return PeriodicGromark.decode(cipherText, plainText, key); }
 *           }
 **/
