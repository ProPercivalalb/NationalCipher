...
public class TriSquareAttack extends CipherAttack {
    ...
    public void attemptAttack(String text, DecryptionMethod method, IApplication app) {
        ...
        if (method == DecryptionMethod.DICTIONARY) {
            ...
            // this.task.onIteration(DictionaryAttack.createLong26Key(word,
            // app.getSettings().getKeywordFiller(), 'J'),
            // DictionaryAttack.createLong26Key(word1, app.getSettings().getKeywordFiller(),
            // 'J'), DictionaryAttack.createLong26Key(word2,
            // app.getSettings().getKeywordFiller(), 'J'));
    ...
    public class TriSquareTask extends SimulatedAnnealing {
        ...
        public Solution modifyKey(double temp, int count, double lastDF) {
            ...
            if (count % 2 == 1)
                ...
                this.lastKey3 = KeyManipulation.modifyKeySquare(this.bestMaximaKey3, 5, 5);
