...
public class QuagmireIAttack extends CipherAttack {
    ...
    public class QuagmireITask extends SimulatedAnnealing {
        ...
        public Solution decode(String key) {
             ...
             * 
             * 
             * String temp = StringTransformer.getEveryNthChar(this.cipherText, i,
             * this.period); int shift = this.findBestCaesarShift(temp.toCharArray(),
             * keyIndex, this.getLanguage()); indicatorKey += key.charAt(shift); }
             * 
