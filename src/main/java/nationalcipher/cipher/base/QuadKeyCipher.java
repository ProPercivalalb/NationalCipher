...
//        });
    ...
    public IKeyType<S> setSecondKeyLimit(Function<B, IKeyBuilder<S>> secondKeyFunc) {
        return this.secondTypeLimit = secondKeyFunc.apply(this.secondKeyBuilder).create();
    }
