...
public class NihilistTranspositionCipher extends BiKeyCipher<Integer[], ReadMode> {
    ...
    public NihilistTranspositionCipher() {
        super(OrderedIntegerKeyType.builder().setRange(2, 7),
                EnumKeyType.builder(ReadMode.class).setUniverse(ReadMode.values())); //Boolean true: read across, false: read down
    }
