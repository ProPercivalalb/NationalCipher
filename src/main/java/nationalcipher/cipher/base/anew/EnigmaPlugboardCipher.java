...
import nationalcipher.cipher.base.QuinKeyCipher;
...
public class EnigmaPlugboardCipher extends QuinKeyCipher<Integer[], Integer[], Integer[], Integer, Integer[], OrderedIntegerKeyType.Builder, OrderedIntegerKeyType.Builder, OrderedIntegerKeyType.Builder, IntegerKeyType.Builder, PlugboardKeyType.Builder> {
    ...
    @Override
    public CharSequence encode(CharSequence plainText, QuinKey<Integer[], Integer[], Integer[], Integer, Integer[]> key, IFormat format) {
        return new CharArrayWrapper(this.decodeEfficently(plainText, key));
    }
    
    @Override
    public char[] decodeEfficently(CharSequence cipherText, @Nullable char[] plainText, QuinKey<Integer[], Integer[], Integer[], Integer, Integer[]> key) {
