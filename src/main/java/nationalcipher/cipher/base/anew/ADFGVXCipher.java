...
public class ADFGVXCipher extends QuadKeyCipher<String, Integer[], String, ReadMode> {
    ...
    public ADFGVXCipher() {
        super(SquareStringKeyType.builder().setAlphabet(KeyGeneration.ALL_36_CHARS).setDim(6, 6),
                OrderedIntegerKeyType.builder().setRange(2, 7),
                ConstantKeyType.builder("ADFGVX"), 
