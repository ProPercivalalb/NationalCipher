...
/**
 * Used to solve ciphers with a string key where each character in the key independently
 * affects a large proportional of the output text. This is used to attack periodic ciphers
 * such as Vigenere, Beaufort, Porta etc.
 * 
 * @author Alex
 *
 */
