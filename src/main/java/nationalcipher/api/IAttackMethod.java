...
public interface IAttackMethod<K> {
    ...
    /**
     * Updates the best solution. Converts the key to a readable form, copies the plaintext array,
     * prints out the solution and updates the solution panel UI.
     * @param tracker The {@link nationalcipher.cipher.decrypt.methods.DecryptionTracker} instances that tracks best solutions
