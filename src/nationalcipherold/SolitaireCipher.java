...
implements Serializable, Cloneable
{
  ...
  protected int nextKeyStream() {
    ...
    System.out.println(keyDeck.toString());
  ...
  public static void main(String args[]) {
    ...
    SolitaireCipher scIn  = new SolitaireCipher((Deck)null);
    SolitaireCipher scOut = (SolitaireCipher)scIn.clone();
    System.out.println(scOut.getDeck().toString());
    String plaintext = args.length > 0 ? args[0] : "PHASEFIVESEAHORSEISREADYFORTRIALSANDTHENAUTILUSSYSTEMISFULLY";
